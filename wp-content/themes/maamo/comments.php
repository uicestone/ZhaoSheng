...
<div class="post-box post-box-replies post-box-comments">
	...
	<div class="post-box-interior post-box-comments-interior">
...
<div class="post-box post-box-replies post-box-trackbacks">
	...
	<div class="post-box-interior post-box-trackbacks-interior">
	<?php if (post_password_required()) : ?>
...
<div class="post-box post-box-reply" id="reply">
	<div class="post-box-title post-box-reply-title">
	...
	<div class="post-box-interior post-box-reply-interior">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="comment-form">
			...
			<p class="input">
				...
				<small>Will not be published<?php if ($req) echo ". Required"; ?></small>
			</p>
			<p class="input">
